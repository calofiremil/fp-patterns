 ...
 *
 *    javac -cp `bin/classpath` GettingStarted.java
 *
 * To run:
 *
...
public class GettingStarted {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            final String schema_path = GettingStarted.class.getResource("/seattle-schema.edn").getPath();
            Reader schema_rdr = new FileReader(schema_path);
            ...
            final String data0_path = GettingStarted.class.getResource("/seattle-data0.edn").getPath();
            Reader data_rdr = new FileReader(data0_path);
            ...
            data_rdr = new FileReader("com/tzapps/book/fp/seattle-data1.edn");
